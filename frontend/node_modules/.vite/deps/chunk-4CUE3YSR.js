...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React18.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React18.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React18.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getItemDomElement = React18.useCallback((itemId) => {
  ...
  const reducerActionContext = React18.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var Menu = React20.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React21.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React22.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var InnerMenuItem = React25.memo(React25.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React25.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React27.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React28.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React29.useState(value ? String(value) : void 0);
  React29.useEffect(() => {
...
var NumberInput = React30.forwardRef(function NumberInput2(props, forwardedRef) {
...
var InnerOption = React32.memo(React32.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React32.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var _excluded26 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox", "size", "slots", "slotProps"];
...
var SvgIcon = React56.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React56.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    size,
  ...
  return (0, import_jsx_runtime47.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime46.jsx)("title", {
...
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["danger", "inherit", "neutral", "primary", "success", "warning"]), import_prop_types29.default.string]),
  /**
   ...
   */
  fontSize: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["inherit", "lg", "md", "sm", "xl", "xl2", "xl3", "xl4", "xs"]), import_prop_types29.default.string]),
  /**
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime48.jsx)(SvgIcon_default, _extends({
  ...
  return React57.memo(React57.forwardRef(Component));
}
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4CUE3YSR.js.map
