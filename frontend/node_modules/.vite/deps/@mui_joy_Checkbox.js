...
import {
  ...
  createSvgIcon,
  useSwitch
} from "./chunk-CLKCVXOB.js";
import "./chunk-5HFNZ4CZ.js";
...
var TypographyNestedContext = React3.createContext(false);
var TypographyInheritContext = React3.createContext(false);
...
var Typography = React3.forwardRef(function Typography2(inProps, ref) {
  ...
  const nesting = React3.useContext(TypographyNestedContext);
  const inheriting = React3.useContext(TypographyInheritContext);
  ...
  return (0, import_jsx_runtime3.jsx)(TypographyNestedContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime4.jsxs)(SlotRoot, _extends({}, rootProps, {
      ...
      })), hasSkeleton ? React3.cloneElement(children, {
...
var _excluded3 = ["checked", "uncheckedIcon", "checkedIcon", "label", "defaultChecked", "disabled", "disableIcon", "overlay", "id", "indeterminate", "indeterminateIcon", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "value", "color", "variant", "size", "component", "slots", "slotProps"];
...
var defaultCheckedIcon = (0, import_jsx_runtime5.jsx)(Check_default, {});
var defaultIndeterminateIcon = (0, import_jsx_runtime5.jsx)(HorizontalRule_default, {});
var Checkbox = React4.forwardRef(function Checkbox2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime6.jsxs)(SlotCheckbox, _extends({}, checkboxProps, {
      children: [(0, import_jsx_runtime5.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime5.jsx)(SlotInput, _extends({}, inputProps))
      })), icon]
    })), label && (0, import_jsx_runtime5.jsx)(TypographyNestedContext.Provider, {
      value: true,
      children: (0, import_jsx_runtime5.jsx)(SlotLabel, _extends({}, labelProps, {
        children: label
      }))
    })]
  }));
