...
function useCompoundItem(id, itemMetadata) {
  const context = React10.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React10.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useOption(params) {
  ...
  const selectOption = React11.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
//# sourceMappingURL=chunk-33NDXH65.js.map
